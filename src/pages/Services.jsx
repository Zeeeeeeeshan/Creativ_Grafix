    ...
    <section>
      ...
      <div className="h-screen w-full flex flex-col items-center justify-start text-center px-8 py-16 bg-[#eeeeee]">
        <h1 className="text-2xl md:text-3xl lg:text-4xl">
          <span className="font-bold text-red-500">BUSINESS</span> PRINTING
          SERVICES
        </h1>
      ...
      <div className="h-screen w-full flex flex-col items-center justify-start text-center px-8 py-16 bg-white">
        <h1 className="text-2xl md:text-3xl lg:text-4xl">
          <span className="font-bold text-red-500">PACKAGING</span> & BRANDING
        </h1>
        <span className="border-2 w-1/12 mt-4"></span>
      </div>
      <div className="h-screen w-full flex flex-col items-center justify-start text-center px-8 py-16 bg-[#eeeeee]">
        <h1 className="text-2xl md:text-3xl lg:text-4xl">
          <span className="font-bold text-red-500">CORPORATE</span> &
      ...
      <div className="h-screen w-full flex flex-col items-center justify-start text-center px-8 py-16 bg-white">
        <h1 className="text-2xl md:text-3xl lg:text-4xl">
          <span className="font-bold text-red-500">RESTAURANT</span> PRINTING
        </h1>
        <span className="border-2 w-1/12 mt-4"></span>
      </div>
      <div className="h-screen w-full flex flex-col items-center justify-start text-center px-8 py-16 bg-[#eeeeee]">
        <h1 className="text-2xl md:text-3xl lg:text-4xl">
          <span className="font-bold text-red-500">SPECIAL</span> PRINTING
        </h1>
        <span className="border-2 w-1/12 mt-4"></span>
      </div>
      <CTA />
